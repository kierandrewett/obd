...
static DTC_MAP: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    ...
    m.insert("P0002", "Fuel Volume Regulator Control Circuit Range/Performance");
    m.insert("P0003", "Fuel Volume Regulator Control Circuit Low");
    m.insert("P0004", "Fuel Volume Regulator Control Circuit High");
    m.insert("P0010", "Intake Camshaft Position Actuator Circuit (Bank 1)");
    m.insert("P0011", "Intake Camshaft Position Timing Over-Advanced (Bank 1)");
    m.insert("P0012", "Intake Camshaft Position Timing Over-Retarded (Bank 1)");
    m.insert("P0013", "Exhaust Camshaft Position Actuator Circuit (Bank 1)");
    m.insert("P0014", "Exhaust Camshaft Position Timing Over-Advanced (Bank 1)");
    m.insert("P0015", "Exhaust Camshaft Position Timing Over-Retarded (Bank 1)");
    m.insert("P0016", "Crankshaft Position - Camshaft Position Correlation (Bank 1 Sensor A)");
    m.insert("P0017", "Crankshaft Position - Camshaft Position Correlation (Bank 1 Sensor B)");
    m.insert("P0018", "Crankshaft Position - Camshaft Position Correlation (Bank 2 Sensor A)");
    m.insert("P0019", "Crankshaft Position - Camshaft Position Correlation (Bank 2 Sensor B)");
    m.insert("P0020", "Intake Camshaft Position Actuator Circuit (Bank 2)");
    m.insert("P0021", "Intake Camshaft Position Timing Over-Advanced (Bank 2)");
    m.insert("P0022", "Intake Camshaft Position Timing Over-Retarded (Bank 2)");
    m.insert("P0023", "Exhaust Camshaft Position Actuator Circuit (Bank 2)");
    m.insert("P0024", "Exhaust Camshaft Position Timing Over-Advanced (Bank 2)");
    m.insert("P0025", "Exhaust Camshaft Position Timing Over-Retarded (Bank 2)");
    m.insert("P0030", "HO2S Heater Control Circuit (Bank 1, Sensor 1)");
    m.insert("P0031", "HO2S Heater Control Circuit Low (Bank 1, Sensor 1)");
    m.insert("P0032", "HO2S Heater Control Circuit High (Bank 1, Sensor 1)");
    m.insert("P0036", "HO2S Heater Control Circuit (Bank 1, Sensor 2)");
    m.insert("P0037", "HO2S Heater Control Circuit Low (Bank 1, Sensor 2)");
    m.insert("P0038", "HO2S Heater Control Circuit High (Bank 1, Sensor 2)");
    ...
    m.insert("P0105", "Manifold Absolute Pressure/Barometric Pressure Circuit");
    ...
    m.insert("P0116", "Engine Coolant Temperature Circuit Range/Performance");
    ...
    m.insert("P0121", "Throttle/Pedal Position Sensor/Switch A Range/Performance");
    m.insert("P0122", "Throttle/Pedal Position Sensor/Switch A Circuit Low Input");
    m.insert("P0123", "Throttle/Pedal Position Sensor/Switch A Circuit High Input");
    m.insert("P0125", "Insufficient Coolant Temperature for Closed Loop Fuel Control");
    m.insert("P0128", "Coolant Thermostat (Coolant Temperature Below Thermostat Regulating Temperature)");
    ...
    m.insert("P0133", "O2 Sensor Circuit Slow Response (Bank 1, Sensor 1)");
    m.insert("P0134", "O2 Sensor Circuit No Activity Detected (Bank 1, Sensor 1)");
    ...
    m.insert("P0139", "O2 Sensor Circuit Slow Response (Bank 1, Sensor 2)");
    m.insert("P0140", "O2 Sensor Circuit No Activity Detected (Bank 1, Sensor 2)");
    ...
    m.insert("P0153", "O2 Sensor Circuit Slow Response (Bank 2, Sensor 1)");
    m.insert("P0154", "O2 Sensor Circuit No Activity Detected (Bank 2, Sensor 1)");
    ...
    m.insert("P0159", "O2 Sensor Circuit Slow Response (Bank 2, Sensor 2)");
    m.insert("P0160", "O2 Sensor Circuit No Activity Detected (Bank 2, Sensor 2)");
    ...
    m.insert("P0221", "Throttle/Pedal Position Sensor/Switch B Range/Performance");
    m.insert("P0222", "Throttle/Pedal Position Sensor/Switch B Circuit Low Input");
    m.insert("P0223", "Throttle/Pedal Position Sensor/Switch B Circuit High Input");
    ...
    m.insert("P0336", "Crankshaft Position Sensor A Circuit Range/Performance");
    m.insert("P0340", "Camshaft Position Sensor A Circuit (Bank 1)");
    m.insert("P0341", "Camshaft Position Sensor A Circuit Range/Performance (Bank 1)");
    m.insert("P0345", "Camshaft Position Sensor A Circuit (Bank 2)");

    // ── Emission Controls ───────────────────────────────────────────────
    m.insert("P0400", "Exhaust Gas Recirculation Flow");
    m.insert("P0401", "Exhaust Gas Recirculation Flow Insufficient Detected");
    m.insert("P0402", "Exhaust Gas Recirculation Flow Excessive Detected");
    m.insert("P0403", "Exhaust Gas Recirculation Circuit");
    m.insert("P0404", "Exhaust Gas Recirculation Circuit Range/Performance");
    ...
    m.insert("P0411", "Secondary Air Injection System Incorrect Flow Detected");
    m.insert("P0420", "Catalyst System Efficiency Below Threshold (Bank 1)");
    m.insert("P0421", "Warm Up Catalyst Efficiency Below Threshold (Bank 1)");
    m.insert("P0430", "Catalyst System Efficiency Below Threshold (Bank 2)");
    m.insert("P0440", "Evaporative Emission Control System");
    m.insert("P0441", "Evaporative Emission Control System Incorrect Purge Flow");
    m.insert("P0442", "Evaporative Emission Control System Leak Detected (Small Leak)");
    m.insert("P0443", "Evaporative Emission Control System Purge Control Valve Circuit");
    m.insert("P0446", "Evaporative Emission Control System Vent Control Circuit");
    m.insert("P0449", "Evaporative Emission Control System Vent Valve/Solenoid Circuit");
    m.insert("P0450", "Evaporative Emission Control System Pressure Sensor");
    m.insert("P0451", "Evaporative Emission Control System Pressure Sensor Range/Performance");
    m.insert("P0452", "Evaporative Emission Control System Pressure Sensor Low Input");
    m.insert("P0453", "Evaporative Emission Control System Pressure Sensor High Input");
    m.insert("P0455", "Evaporative Emission Control System Leak Detected (Gross Leak)");
    m.insert("P0456", "Evaporative Emission Control System Leak Detected (Very Small Leak)");
    ...
    m.insert("P0521", "Engine Oil Pressure Sensor/Switch Range/Performance");
    ...
    m.insert("P0706", "Transmission Range Sensor Circuit Range/Performance");
    ...
    m.insert("P0741", "Torque Converter Clutch Circuit Performance or Stuck Off");
...
pub fn describe(code: &str) -> &'static str {
    DTC_MAP.get(code.to_uppercase().as_str()).copied().unwrap_or("")
}